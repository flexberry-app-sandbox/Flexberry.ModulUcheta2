...
namespace IIS.ModulUcheta
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ModulUcheta.Статус fСтатус;
        
        private IIS.ModulUcheta.ТипДоговора fТип;
        
        private int fСтоимость;
        
        private double fДлительность;
        
        private IIS.ModulUcheta.ЕдВремени fЕдВремени;
        
        private IIS.ModulUcheta.Клиент fКлиент;
        
        private IIS.ModulUcheta.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        ...
        public virtual IIS.ModulUcheta.ЕдВремени ЕдВремени
        {
            get
            {
                ...
                IIS.ModulUcheta.ЕдВремени result = this.fЕдВремени;
        ...
        public virtual IIS.ModulUcheta.Статус Статус
        {
            get
            {
                ...
                IIS.ModulUcheta.Статус result = this.fСтатус;
        ...
        public virtual IIS.ModulUcheta.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.ModulUcheta.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.ModulUcheta.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.ModulUcheta.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.ModulUcheta.Клиент Клиент
        {
            get
            {
                ...
                IIS.ModulUcheta.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.ModulUcheta.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.ModulUcheta.Договор));
                }
            }
        }
    }
