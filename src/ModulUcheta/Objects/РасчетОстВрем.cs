...
namespace IIS.ModulUcheta
{
    ...
    [View("РасчетОстВремE", new string[] {
            ...
            "Дата as \'Дата\'",
            "Договор as \'Договор\'",
            "Договор.Номер as \'Номер\'"}, Hidden=new string[] {
            "Договор.Номер"})]
    ...
    public class РасчетОстВрем : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ModulUcheta.Договор fДоговор;
        
        private IIS.ModulUcheta.DetailArrayOfОказаниеУслуг fОказаниеУслуг;
        ...
        [PropertyStorage(new string[] {
                "Договор"})]
        [NotNull()]
        public virtual IIS.ModulUcheta.Договор Договор
        {
            get
            {
                ...
                IIS.ModulUcheta.Договор result = this.fДоговор;
        ...
        public virtual IIS.ModulUcheta.DetailArrayOfОказаниеУслуг ОказаниеУслуг
        {
            get
            {
                ...
                {
                    this.fОказаниеУслуг = new IIS.ModulUcheta.DetailArrayOfОказаниеУслуг(this);
                }
                IIS.ModulUcheta.DetailArrayOfОказаниеУслуг result = this.fОказаниеУслуг;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетВремениE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетВремениE", typeof(IIS.ModulUcheta.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетВремениL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетВремениL", typeof(IIS.ModulUcheta.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремE", typeof(IIS.ModulUcheta.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремL", typeof(IIS.ModulUcheta.РасчетОстВрем));
                }
            }
        }
    }
